...
use Drupal\social_auth_hid\Settings\HidAuthSettings;
...
class HidAuth extends NetworkBase implements HidAuthInterface {
  ...
  protected function initSdk() {
    ...
    if ($this->validateConfig($settings)) {
      ...
      return new HumanitarianId($league_settings);
    }
    return FALSE;
  }
   ...
   *   False otherwise.
   */
  protected function validateConfig(HidAuthSettings $settings) {
